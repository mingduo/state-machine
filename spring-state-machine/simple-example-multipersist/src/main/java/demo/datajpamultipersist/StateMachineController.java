...
public class StateMachineController {
    ...
    /*    if ( StringUtils.startsWithIgnoreCase(machine,MACHINE_ID_2)) {
            stateMachineContext = stateMachinePersist.read(machine);
            if (stateMachineContext != null) {
                contextBuf.append("\n---\n");
                contextBuf.append(stateMachineContext.toString());
            }
        ...
        System.out.println(currentStateMachine.getExtendedState().getVariables());
        return currentStateMachine.toString();
    }
    ...
    private void setId(String machineId) {
        int i = machineId.indexOf("_");
        currentStateMachine.getExtendedState().getVariables().put("id", machineId.substring(i + 1));
    }
