...
public class StateMachineConfig {
    ...
    public StateMachineRuntimePersister<String, String, String> stateMachineRuntimePersister(
        ...
        JpaRepositoryStateMachinePersist<String, String> persist = new MyJpaRepositoryStateMachinePersist<>(jpaStateMachineRepository);
...
//end::snippetA[]
    ...
    public StateMachineService<String, String> stateMachineService(
        ...
        return new MyDefaultStateMachineService<>(stateMachineFactory, stateMachineRuntimePersister);
    }
//end::snippetB[]
