...
import com.mingduo.springboot.statemache.config.StateMachineLogListener;
...
public class StateController {
    ...
    @GetMapping("/state")
    public StateMachineContext getStateView(@RequestParam(value = "machine", defaultValue = MACHINE_ID_1) String machineId) {
        try {
    ...
    private synchronized StateMachine<States, Events> getStateMachine(String machineId) throws Exception {
        ...
        System.out.println(createMessages(listener.getMessages()));
